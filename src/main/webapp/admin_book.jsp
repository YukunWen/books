...
<%@ page import="com.rain.booklib.bean.TypeBean,
				 com.rain.booklib.dao.AdminDao,
				 com.rain.booklib.dao.TypeDao,
				 com.rain.booklib.bean.BookBean,
				 com.rain.booklib.dao.BookDao,
				 com.rain.booklib.bean.AdminBean" %>
                        ...
                        <td>
                            <button type="button" class="btn btn-warning btn-xs" data-toggle="modal"
                                    ...
                                    onclick="showInfo2(<%= bean.getBid() %>,<%= bean.getCard() %>,<%= bean.getType() %>,<%= bean.getName() %>
                                            ,<%= bean.getAutho() %>,<%= bean.getPress() %>,<%= bean.getNum() %>)">修改
                            </button>
